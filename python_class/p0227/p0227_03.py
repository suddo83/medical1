...
print(str1[1:6]) # [b,c,d,e,f] 출력
print(str1[0:3]) # [a,b,c] 출력
print(str1[0:6]) # [a,b,c,d,e,f] 출력
print(str1[1:5]) # [b,c,d,e] 출력
...
# 해보세요
tmp = [['미국','영어','일본','중국','스페인'],['영어','영어','일본어','중국어','스페인어']]
